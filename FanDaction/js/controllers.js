...
function editSettingsController($scope, $animateInstance, dataservice, setting) {
    $scope.modalTitle = "Edit Setting";
...
angular
    ...
    .controller('lobbyCtlr', lobbyCtlr)
    .controller('aboutMeCtlr', aboutMeCtlr)
    .controller('settingsCtlr', settingsCtlr)
    .controller('categoryListCtlr', categoryListCtlr)
