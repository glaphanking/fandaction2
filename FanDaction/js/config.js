...
function config($stateProvider, $urlRouterProvider, $ocLazyLoadProvider, IdleProvider, KeepaliveProvider) {
    ...
    $urlRouterProvider.otherwise("/main/lobby");
    ...
    .state('main.lobby', {
        url: "/lobby",
        templateUrl: "views/front/lobby.html",
        data: { pageTitle: 'Main Lobby' },
        resolve: {
            loadPlugin: function ($ocLazyLoad) {
                return $ocLazyLoad.load([
    ...
    .state('admin.admins', {
        url: "/admins",
        templateUrl: "views/back/adminsList.html",

    })
    .state('admin.emails', {
        url: "/emails",
        templateUrl: "views/back/autoemail.html",
    })
    .state('admin.settings', {
        url: "/settings",
        templateUrl: "views/back/settings.html",

    })
        .state('admin.categories', {
            url: "/categories",
            templateUrl: "views/back/categories.html",
        })
    .state('account', {
        abstract: true,
        url: "/account",
    ...
    .state('account.aboutme', {
        url: "/aboutme",
        templateUrl: "views/front/account/aboutMe.html",
    });
